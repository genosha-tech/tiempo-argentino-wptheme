    ...
    <div class="container">
        <div class="text-left mx-auto">
            ...
            <div class="pl-lg-5">
                ...
                <div class="subtitle">
                    <h3>El gobernador sobreactuó su gesta por la salud pública con dos medidas sorprendentes:
                        la súbita expulsión de 61 migrantes de países de latinoamerica.</h3>
                </div>
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <p class="date mb-0">dd/mm/aa</p>
                    <div class="social-btns">
                        ...
                        <a href="">
                            <img src="../../assets/images/guardar.svg" alt="" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-column flex-md-row">
                <div class="author d-flex mx-2">
                    ...
                    <div class="author-info">
                        ...
                        <p>ESPECIALISTA (puede que no lo aclaren)</p>
                        <a href="">@RRagendorfer</a>
                    </div>
                </div>
            </div>
